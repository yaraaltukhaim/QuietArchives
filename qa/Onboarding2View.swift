...
struct Onboarding2View: View {
    ...
    private let fullText: String = "Thus begins Arlo's journey, into the forest deep,In pursuit of a potion, his lost voice to keep."
...
struct Gif2View: UIViewRepresentable {
    let name: String
